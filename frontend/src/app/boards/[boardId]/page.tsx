...
function SetupAgentsBanner({
  ...
  const hasAutoProvision =
    isCodeFarm || agentRoster.some((a) => a.soulTemplate);
  ...
  // Templates with soul templates or GitHub repo: show auto-provision button
  if (hasAutoProvision) {
    const bannerLabel = isCodeFarm
      ? "Code Farm board ready"
      : template
        ? `${template.name} board ready`
        : "Board created";
    const bannerIcon = isCodeFarm ? "🌾" : "🚀";
    return (
